...
def calculate_loss(args, aggre_net, img1_kps, img2_kps, img1_desc, img2_desc, img1_threshold, img2_threshold, mask1, mask2, num_patches, device, raw_permute_list=None, img1_desc_flip=None, img2_desc_flip=None, corr_map_net=None, flipped=False):
    ...
    desc_2 = img2_desc_flip if flipped else img2_desc

    loss = cal_clip_loss(img1_desc[0, img1_patch_idx,:], desc_2[0, img2_patch_idx,:], aggre_net.logit_scale.exp(), self_logit_scale=aggre_net.self_logit_scale.exp()) 
    ...
    if args.DENSE_OBJ > 0: # dense training objective loss
        ...
        EPE_loss = get_corr_map_loss(img1_desc, desc_2, corr_map_net, flow_idx, gt_flow, num_patches, img2_patch_idx=flow_idx2)
